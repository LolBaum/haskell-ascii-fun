...
/* package haskell-ascii-0.1.0.0 */
#ifndef VERSION_haskell_ascii
#define VERSION_haskell_ascii "0.1.0.0"
#endif /* VERSION_haskell_ascii */
#ifndef MIN_VERSION_haskell_ascii
#define MIN_VERSION_haskell_ascii(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_ascii */
...
#define CURRENT_COMPONENT_ID "haskell-ascii-0.1.0.0-inplace-haskell-ascii"
